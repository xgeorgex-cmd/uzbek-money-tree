        ...
        {items.map((item) => {
          ...
          return (
            <button
              ...
              className="flex flex-col items-center gap-0.5 p-2 rounded-xl transition-colors relative"
            >
              {isActive && (
                <motion.div
                  layoutId="nav-active"
              ...
              />
              <span
                className={`text-[11px] font-semibold relative z-10 ${isActive ? 'text-primary' : 'text-muted-foreground'}`}
              >
                {item.label}
              </span>
            </button>
