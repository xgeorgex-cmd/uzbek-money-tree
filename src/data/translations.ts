...
export const translations: Record<Language, TranslationKeys> = {
  ru: {
    ...
    orderCardStep3: 'Наклей на телефон — плати, копи и пользуйся! 🎉',
  ...
  uz: {
    ...
    orderCardStep3: 'Telefonga yopishtirib — to\'la, yig\' va foydalaning! 🎉',
  ...
  en: {
    ...
    orderCardStep3: 'Stick it on your phone — pay, save and enjoy! 🎉',
